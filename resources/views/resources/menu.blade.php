    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal " href="index.html">
                <img src="https://certificacion.itzam.org/images/logo-itzam-light.png" style="width:150px;" class="header-brand-img desktop-logo" alt="logo">
                <img src="https://certificacion.itzam.org/images/logo-itzam-light.png" style="width:150px;" class="header-brand-img light-logo1"
                    alt="logo">
            </a>
            <!-- LOGO -->
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    <div class="drop-heading">
                                        <div class="text-center">
                                            <h5 class="text-dark mb-0 fs-14 fw-semibold">{{ auth()->user()->name.' '.auth()->user()->last_name }}</h5>
    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="index.html">
                <img src="https://certificacion.itzam.org/images/logo-itzam-light.png" class="header-brand-img desktop-logo" alt="logo">
                <img src="https://certificacion.itzam.org/images/logo-itzam-light.png" class="header-brand-img toggle-logo"
                    alt="logo">
                <img src="https://certificacion.itzam.org/images/logo-itzam-light.png" class="header-brand-img light-logo" alt="logo">
                <img src="https://certificacion.itzam.org/images/logo-itzam-light.png" class="header-brand-img light-logo1"
                    alt="logo">
            </a>
            <!-- LOGO -->
        </div>
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#"><i
                            class="side-menu__icon fe fe-homes"></i><span
                            class="side-menu__label">Entregas</span></a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#"><i
                            class="side-menu__icon fe fe-homes"></i><span
